Gradient descent diverges when the learning rate exceeds the local curvature bound. We observed oscillations, not spikes, at lr=0.1 on the quadratic benchmark.
